...
<script type="text/javascript">
	function fn_onClickMenu(menu){
		...
		if(tempValue == 0){
			...
			frm.target = "por"; // iframe의 이름
			frm.action = "write?header_contents="+encodeURI(encodeURIComponent(contents));
			frm.submit();
			...
			if(header_content != null){
				...
				//String strPath = basicPath+"\\settingProject\\src\\main\\java\\set\\set\\set\\serviceImpl\\HomeServiceImpl1.java";
				String strPath = basicPath+"\\settingProject\\src\\main\\webapp\\WEB-INF\\views\\index.jsp";
			...
			if(header_content1 != null){
				String header_contents = "<%@ page language='java' contentType='text/html; charset=UTF-8' pageEncoding='UTF-8'"+"% >".replaceAll(" ", "")+"\n"+URLDecoder.decode(header_content1,"UTF-8").trim();
				
				String basicPath = this.getClass().getResource("").getPath();
				basicPath = basicPath.substring(1, basicPath.indexOf(".metadata"));
				String strPath = basicPath+"\\settingProject\\src\\main\\webapp\\WEB-INF\\views\\header.jsp";
